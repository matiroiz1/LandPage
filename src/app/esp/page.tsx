...
import ContactSection from '../../components/ContactSectionESP';
  ...
  const studies = [
    {
      ...
      description: `2022 - Presente (Cursando 4°Año)\nUTN - Facultad Regional Mendoza.`,
    },
    {
      ...
      <section className="container mx-auto px-4 py-13 md:py-24 flex flex-col md:flex-row items-center mt-18">
        <div className="md:w-1/2 space-y-6 flex flex-col items-center text-center">
          ...
          <p className="text-lg md:text-xl">
            <b>Matías Roiz</b>, Estudiante avanzado de Ingeniería de Sistemas, apasionado por la tecnología y el desarrollo de software. 
            Estoy comprometido con mi crecimiento profesional y con adquirir experiencia práctica en la industria IT.
          </p>
          <div>
            <a
